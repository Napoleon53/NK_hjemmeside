...
gamle udgave ligger urørt i `../../superlab/sc2.7_blyiodid/` og kører videre
med sin egen `forsoeg.js`, `scene.js`, `bord.js` og `model.js`. Denne bruger
den fælles motor og består af seks små filer. Den hed
`superlab/sc2.7_oploeselighed/`, til forsøgene på den nye motor fik deres
egen mappe, `superlab_ny/`, og endelsen `_ny` (20. september 2026).
...
`../../kemichael/` og prøvebordets `laerer.js`, og skal derfor ligge i
`superlab_ny/`.
