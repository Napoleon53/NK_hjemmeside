/* =====================================================================
   app.js - binder de tre faner sammen (som sc7.2)
...
(function () {
    ...
    var sims = {};
    var faner = ["fane-titrering", "fane-beregning", "fane-forbrug"];
    ...
    function visFane(id) {
        ...
        if (sims[id]) {
            sims[id].tilpas();
            if (sims[id].tjekEgen) sims[id].tjekEgen();   /* en ny maaling fra fane 1 */
    ...
    function start() {
        ...
        sims["fane-titrering"] = new NK.SimTitrering();
        sims["fane-beregning"] = new NK.SimBeregning();
        sims["fane-forbrug"] = new NK.SimForbrug();
