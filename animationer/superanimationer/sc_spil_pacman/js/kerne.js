/* =====================================================================
   kerne.js - faelles hjaelpefunktioner for Pacman Quiz

   Alt bor i det globale objekt NK. Ingen moduler og ingen fetch:
   mappen skal ogsaa virke, naar index.html aabnes direkte fra
   harddisken (file://). Hjaelperne til Kemichael er de samme som i
   sc2.4 og sc_spil_jeopardy.
   ===================================================================== */
var NK = window.NK || {};
window.NK = NK;
...
(function () {
    ...
    /* Et tal, som det skrives paa dansk: decimalkomma, hoejst tre
       decimaler, ingen overfloedige nuller og rigtigt minus (−).
       NK.tal(0.5) = "0,5", NK.tal(-2) = "−2", NK.tal(1 / 6) = "0,167". */
    NK.tal = function (v) {
