/* =====================================================================
   ...
   en kort tekst. Samme opbygning som i sc2.4 og sc_spil_jeopardy.
   Spillet staar stille, mens rundvisningen er aaben (js/app.js).
...
(function () {
    ...
    var TURE = {
        "start": [
            { sel: "#svaerhed", titel: "Sværhedsgrad", tekst: "Bestemmer, hvor længe spøgelserne sover, og hvor hurtige de er. På Svær kommer der flere til undervejs." },
            { sel: "#emner", titel: "Emnerne", tekst: "Hvert emne har 10 opgaver, Grundstoffer har 32, og Mix har 24 fra alle emner. Prikkerne viser, hvilke sværhedsgrader du har klaret." },
            { sel: "#regelknap", titel: "Reglerne", tekst: "Reglerne, tallene bag sværhedsgraderne og tastaturet." }
        ],
        "spil": [
            { sel: "#sp-midt", titel: "Spørgsmålet", tekst: "Svaret står på et skilt i et af de fire rum." },
            { sel: "#bane", titel: "Labyrinten", tekst: "Piletasterne flytter dig ét felt. Løb ind i rummet med det rigtige svar. Den gule mønt giver et skjold i 5 s." },
            { sel: "#liv", titel: "Livene", tekst: "Et forkert rum eller et spøgelse koster et liv. Er alle tre brugt, starter emnet forfra." },
            { sel: "#emneknap", titel: "Emner", tekst: "Tilbage til emnerne. Forløbet starter forfra næste gang." }
        ],
        "kort": [
            { sel: ".kort:not([hidden])", titel: "Svaret", tekst: "Læs forklaringen. Enter går videre." }
        ]
    };
