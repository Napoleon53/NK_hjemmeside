/* =====================================================================
   ...
   kobles i hver fane (NK.Praesentation.kobl i sim_*.js). Samme opbygning
   som sc6.6.
   ===================================================================== */
(function () {
    "use strict";
    ...
    var sims = {};
    var faner = ["fane-hydron", "fane-produkter", "fane-par"];
    ...
    function start() {
        ...
        sims["fane-hydron"] = new NK.SimHydron();
        sims["fane-produkter"] = new NK.SimProdukter();
        sims["fane-par"] = new NK.SimPar();
        ...
        /* Man kan linke direkte til en fane med  index.html#par  */
