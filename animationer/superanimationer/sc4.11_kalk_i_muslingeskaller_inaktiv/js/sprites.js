...
(function () {
    ...
    var MAAL = {
        /* Den koniske kolbe (som sc7.4): aabningen (75, 4), indersidens bund y 192 */
        kolbe: { b: 150, h: 200, bund: 197 },
        /* Morteren og hjertemuslingen: de staar paa y 116 og 100 */
        morter: { b: 140, h: 120, bund: 116 },
        muslingeskal: { b: 120, h: 104, bund: 100 },
        /* Vaegten og vejebaaden (som sc4.5) */
    ...
    function indlaes(navn, f) {
        ...
        post.img.addEventListener("error", function () {
            if (window.console) console.warn("sc4.11: kunne ikke indlaese " + sti);
        });
        post.img.src = sti;
    }
