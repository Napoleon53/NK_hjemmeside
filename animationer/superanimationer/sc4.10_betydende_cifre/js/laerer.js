/* =====================================================================
   laerer.js - Kemichael ved katederet (den rolige udgave)

   Samme fil som i sc4.5 (kun noeglen i browseren er ny). Kemichael gaar
   ikke ind og ud af scenen. Han sidder stille bag sit kateder i scenens
   nederste venstre hjoerne med kaffen foran sig, og han blander sig
   ikke: han siger kun noget, naar eleven trykker Giv hint eller Vis
   svaret (eller K). Boblen staar fast til hoejre for ham og lukker igen,
   naar opgaven er loest. Naeste skridt, fejl og ros staar i linjen under
   svarfeltet, ikke hos ham (brugerens valg 25. sept. 2026).

   Knappen i scenens hjoerne sender ham ud. Saa staar katederet tomt med
   en seddel, og hintene staar i linjen under svarfeltet i stedet. Samme
   knap (eller et klik paa sedlen) henter ham igen. Her er der kun én
   scene, saa én Kemichael deles af alle fire faner. Valget huskes i
   browseren.
   ...
   Brug:
     this.k = new NK.RoligLaerer({ boble: "boble", knap: "kknap" });
...
(function () {
    ...
    /* Ude eller inde gaelder alle fire faner */
    var NOEGLE_UDE = "nk-sc4.10-kemichael-ude";
