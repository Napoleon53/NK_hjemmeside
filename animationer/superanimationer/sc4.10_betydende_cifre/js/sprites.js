/* =====================================================================
   ...
   Her er der kun ét sprite af vores eget: Kemichaels kateder (samme fil
   som i sc4.5). ../../v2/kemichael/kemichael.js tilfoejer laererens
   sprites og kaffekoppen med deres egen mappe, derfor startes
   indlaesningen foerst fra app.js.

   MAAL er de koordinater, der staar i kommentaren oeverst i SVG-filen.
   ===================================================================== */
(function () {
    "use strict";
    ...
    function indlaes(navn, f) {
        ...
        post.img.addEventListener("error", function () {
            if (window.console) console.warn("sc4.10: kunne ikke indlaese " + sti);
        });
        post.img.src = sti;
    }
