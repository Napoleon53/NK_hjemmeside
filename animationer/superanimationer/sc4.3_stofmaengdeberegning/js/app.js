...
(function () {
    ...
    var sims = {};
    var faner = ["fane-formel", "fane-vaegt", "fane-hurtig"];
    ...
    function loekke(tidsstempel) {
        ...
        if (sim) {
            sim.tilpas();
            /* Uret i Hurtigrunden staar stille, mens teorien eller rundvisningen er aaben */
            var pause = document.querySelector(".overlay.vis") || NK.Rundvisning.aktiv();
            sim.opdater(pause ? 0 : dt * NK.tid.skala);
            sim.tegn();
        }
    ...
    function tastatur(e) {
        ...
        /* I Hurtigrunden svarer tallene, mens runden koerer */
    ...
    function start() {
        ...
        sims["fane-hurtig"] = new NK.SimHurtig();
        ...
        /* Man kan linke direkte til en fane med  index.html#vaegt  */
