/* =====================================================================
   sprites.js - indlaeser SVG-sprites fra mappen sprites/ (som sc7.4)
...
(function () {
    ...
    /* Baegerglasset er det samme som i sc2.1 og sc7.2 */
    var MAAL = {
    ...
    function indlaes(navn, f) {
        ...
        post.img.addEventListener("error", function () {
            if (window.console) console.warn("sc8.1: kunne ikke indlaese " + sti);
        });
        post.img.src = sti;
    }
