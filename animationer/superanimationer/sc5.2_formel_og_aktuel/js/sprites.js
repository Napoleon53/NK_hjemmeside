...
(function () {
    ...
    var MAAL = {
        /* Literglasset paa fane 1 */
        glas1l: { b: 240, h: 300, indV: 22, indH: 218, indTop: 20, indBund: 280, indR: 10, prL: 220, bund: 286 },
        /* Baegerglasset paa fane 3 (400 mL, som sc5.1) */
    ...
    function indlaes(navn, f) {
        ...
        post.img.addEventListener("error", function () {
            if (window.console) console.warn("sc5.2: kunne ikke indlaese " + sti);
        });
        post.img.src = sti;
    }
