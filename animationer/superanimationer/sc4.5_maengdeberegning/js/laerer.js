/* =====================================================================
   ...
   et klik paa sedlen) henter ham igen. Valget gaelder alle tre faner og
   huskes i browseren.
   ...
   Brug (én pr. fane):
     this.k = new NK.RoligLaerer({ boble: "vej-boble", knap: "vej-kknap" });
...
(function () {
    ...
    /* Ude eller inde gaelder alle tre faner */
    var NOEGLE_UDE = "nk-sc4.5-kemichael-ude";
