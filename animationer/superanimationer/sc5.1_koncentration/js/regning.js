/* =====================================================================
   ...
   og saa tallet (brugerens oenske fra sc7.4). Et trin med molarmassen
   har kun tallet. Kun det aktive trin er aabent.
...
(function () {
    ...
    P.saet = function (opg) {
        ...
        this.felter = opg.trin.map(function (id, i) {
            return { id: id, status: i === 0 ? "aktiv" : "laast", fase: D.TRIN[id].formel ? "formel" : "tal" };
        });
        this.byg();
    };
    ...
    P.trinTekst = function () {
        ...
        var hvad = f.fase === "formel" ? "Skriv <b>formlen</b> for " + NK.html(T.venstre(f.id, this.opg)) + "." : "Skriv <b>tallet</b>.";
    ...
    P.tegnTavle = function (ctx, r, data, tid) {
        ...
        var f = NK.klamp(Math.min(r.h / 14, r.b / 30), 13, 20);
