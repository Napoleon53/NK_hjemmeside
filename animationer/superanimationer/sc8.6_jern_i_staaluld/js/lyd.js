/* =====================================================================
   ...
   Ståluld i vejebaaden, haeldning, bobler, draaber fra buretten, glas,
   skvulp, vaegtens bip, laererens brummen og mumlen, en slurk kaffe og
...
(function () {
    ...
    try {
        var gemt = window.localStorage && window.localStorage.getItem("nk-sc86-lyd");
    ...
    NK.Lyd = {
        ...
        saet: function (v) {
            til = !!v;
            try { window.localStorage && window.localStorage.setItem("nk-sc86-lyd", til ? "til" : "fra"); } catch (fejl) {}
        },
        ...
        /* En tot ståluld lander i vejebaaden */
        tik: function () {
            var c = klar(); if (!c) return;
        ...
        /* Brintbobler: et par smaa plop og en svag hvislen */
        boble: function () {
            var c = klar(); if (!c) return;
            var nu = c.currentTime;
