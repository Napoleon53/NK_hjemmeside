/* =====================================================================
   laerer.js - den sure laerer og paaskeaeggene
   ...
   Paaskeaeg:
     ...
     aubergine  der titreres langt forbi endepunktet
...
(function () {
    ...
    P.klikLaerer = function () {
        var L = this.laerer;
        if (!L || L.x < -100 || (L.scene && L.scene.navn === "gaaUd")) return false;
        L.klik++;
        L.vredeMaal = 1;
        L.humoerMaal = -1;
    ...
    P.laererRyst = function () {
        ...
        this.stopArbejde();
        this.holdt = null;
        var tekst = RYST_SVAR[(this.antalRyst - 1) % RYST_SVAR.length];
    ...
    /* ----- Langt forbi endepunktet -------------------------------------- */
    P.laererAubergine = function () {
        var L = this.laerer;
        if (!L || L.scene) return false;
        this.laererKoer("aubergine", [
            { udtryk: { vrede: 0.4, humoer: -0.2, roed: 0, skeptisk: 1 } },
            { gaa: 200 },
    ...
    P.opdaterLaerer = function (dt) {
        ...
        if (!L.scene && this.over100Venter) this.laererOver100();
    ...
    P.tegnAnsigt = function (ctx, L) {
        ...
        /* Bryn: vrede saenker de inderste ender. Skeptisk: det hoejre bryn
           loeftes, og munden bliver skaev */
