...
(function () {
    ...
    try {
        var gemt = window.localStorage && window.localStorage.getItem("nk-sc34-lyd");
    ...
    NK.Lyd = {
        ...
        saet: function (v) {
            til = !!v;
            try { window.localStorage && window.localStorage.setItem("nk-sc34-lyd", til ? "til" : "fra"); } catch (fejl) {}
