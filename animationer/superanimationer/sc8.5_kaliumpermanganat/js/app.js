...
(function () {
    ...
    function tastatur(e) {
        ...
        if (e.key === "Escape") {
            lukAlle();
            if (NK.Rundvisning) NK.Rundvisning.luk();
            if (sim && sim.valgt) sim.valgt = null;
            return;
        }
        ...
        /* Et tal eller et tegn uden for feltet: skriv i feltet i stedet */
    ...
    function start() {
        ...
        sims["fane-ug"] = new NK.SimUrglas();
        sims["fane-fl"] = new NK.SimFlere();
        ...
        document.addEventListener("click", function (e) {
            ...
            e.preventDefault();
            var sim = sims[aktivFane];
            if (sim && sim.visForklaring) sim.visForklaring();
        });

        document.addEventListener("keydown", tastatur);

        /* Man kan linke direkte til en fane med  index.html#flere  */
        var oenske = (window.location.hash || "").replace(/^#/, "").toLowerCase();
        var HASH = { urglas: "fane-ug", urglassene: "fane-ug", flere: "fane-fl", reaktioner: "fane-fl",
                     ekstra: "fane-fl" };
