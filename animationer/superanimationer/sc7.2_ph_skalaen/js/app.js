...
(function () {
    ...
    var sims = {};
    var faner = ["fane-skala", "fane-lup", "fane-fortynd"];
    ...
    function start() {
        ...
        sims["fane-skala"] = new NK.SimSkala();
        sims["fane-lup"] = new NK.SimLup();
        ...
        /* Man kan linke direkte til en fane med  index.html#lup  */
