...
(function () {
    ...
    var sims = {};
    var faner = ["fane-fabrik", "fane-koele"];
    ...
    function start() {
        ...
        sims["fane-fabrik"] = new NK.SimFabrik();
        sims["fane-koele"] = new NK.SimKoele();
        ...
        /* Man kan linke direkte til en fane med  index.html#koele  */
