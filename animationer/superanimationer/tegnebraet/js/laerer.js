/* =====================================================================
   laerer.js - Kemichael ved tegnebraettet (samme kode som i sc6.2)
   ...
   side har intet fast tegnebord, saa laereren tegnes skaleret efter
   ...
   Fanen (NK.Fane i fane.js) har this.tid, this.L og this.lay.
   Kaffekoppen staar naesten gemt i scenens nederste hoejre hjoerne og
   er paaskeaegget.

   Scener:
     intro     praesentationen (D.INTRO_TEGN), naar eleven vil
   ===================================================================== */
(function () {
    "use strict";
    ...
    /* ----- Tegnebraettet ------------------------------------------------------ */
    var PT = NK.SimTegn.prototype;
    kobl(PT);
    PT.laererIntro = function () {
        if (!this.laerer) return;
        this.laererKoer("intro", introTrin(this, D.INTRO_TEGN, {
