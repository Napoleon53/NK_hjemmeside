/* =====================================================================
   valg.js - det molekyle, man har valgt paa fane 2 og 3

   Begge faner viser den samme raekke molekyleknapper og det samme valg.
   Mens en opgave er i gang, viser fanen opgavens molekyle, og knapperne
   paa den fane er laast (se sim.molId() og sim.menuLaast()).
   ===================================================================== */
(function () {
    "use strict";
