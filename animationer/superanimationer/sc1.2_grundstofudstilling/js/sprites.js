...
(function () {
    ...
    var MAAL = {
        /* Akrylkuben: proeven staar i forsidens indre */
        kube: { b: 60, h: 60, indV: 8, indH: 48, indTop: 14, indBund: 54 },
        /* Ampullen: omridset staar i AMPUL i tegning.js */
        ampul: { b: 40, h: 100 },
        /* Glasset med olie */
        olie: { b: 44, h: 80, indV: 6, indH: 38, indTop: 22, indBund: 76, indR: 5 },
        /* Reagensflasken paa fane 2 */
    ...
    function indlaes(navn, f) {
        ...
        post.img.addEventListener("error", function () {
            if (window.console) console.warn("sc1.2: kunne ikke indlaese " + sti);
        });
        post.img.src = sti;
    }
