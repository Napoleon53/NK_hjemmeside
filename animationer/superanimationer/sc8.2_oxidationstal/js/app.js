...
(function () {
    ...
    function start() {
        ...
        /* Man kan linke direkte til en fane med  index.html#elektroner  */
        var oenske = (window.location.hash || "").replace(/^#/, "").toLowerCase();
        var HASH = { regler: "fane-rg", reglerne: "fane-rg", elektroner: "fane-ek", elektronerne: "fane-ek",
                     elektronegativitet: "fane-ek" };
