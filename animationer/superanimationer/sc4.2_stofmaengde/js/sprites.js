/* =====================================================================
   ...
   Vaegten og vejebaaden er de samme som i sc4.1, pulverglasset det samme
   som i sc2.3. ../../v2/kemichael/kemichael.js tilfoejer laererens
   sprites (og kaffekoppen) med deres egen mappe, derfor startes
   indlaesningen foerst fra app.js.
...
(function () {
    ...
    var MAAL = {
        ...
        /* Vejebaaden, som proeverne ligger i paa fane 2 og 3 */
        vejebaad: { b: 120, h: 36, indV: 16, indH: 104, indBund: 14, bund: 34 },
        /* Krukken med metallet: det indre og feltet til etiketten */
        pulverglas: { b: 100, h: 130, indV: 10, indH: 90, indTop: 34, indBund: 126, indR: 9,
                      etiketV: 12, etiketH: 88, etiketTop: 54, etiketBund: 108 }
    };

    /* Vaegten er 24 cm bred, saa 1 cm er 10 enheder i filen. Klumperne
       paa fane 1 tegnes i den skala. */
    MAAL.vaegt.cm = 10;
    ...
    function indlaes(navn, f) {
        ...
        post.img.addEventListener("error", function () {
            if (window.console) console.warn("sc4.2: kunne ikke indlaese " + sti);
        });
        post.img.src = sti;
    }
