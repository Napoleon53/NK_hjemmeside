...
(function () {
    ...
    var sims = {};
    var faner = ["fane-vaegt", "fane-atomer", "fane-afvej"];
    ...
    function tastatur(e) {
        ...
        /* Svarene paa fane 2 ligger paa piletasterne */
    ...
    function start() {
        ...
        sims["fane-atomer"] = new NK.SimAtomer();
        sims["fane-afvej"] = new NK.SimAfvej();
        ...
        /* Man kan linke direkte til en fane med  index.html#atomer  */
